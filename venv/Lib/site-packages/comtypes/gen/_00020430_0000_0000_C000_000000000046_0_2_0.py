...
__all__ = [
    'OLE_XSIZE_HIMETRIC', 'Monochrome', 'OLE_YPOS_HIMETRIC',
    'FONTSTRIKETHROUGH', 'OLE_OPTEXCLUSIVE', 'OLE_HANDLE',
    'OLE_XSIZE_PIXELS', 'FONTUNDERSCORE', 'Default',
    'IFontEventsDisp', 'FONTBOLD', 'OLE_YPOS_PIXELS', 'Gray',
    'OLE_CANCELBOOL', 'OLE_ENABLEDEFAULTBOOL', 'LoadPictureConstants',
    'StdFont', 'Font', 'FONTNAME', 'VgaColor', 'OLE_COLOR', 'Checked',
    'OLE_XPOS_PIXELS', 'OLE_TRISTATE', 'IPicture', 'IPictureDisp',
    'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC', 'IFont',
    'OLE_XPOS_CONTAINER', 'Color', 'FONTITALIC', 'StdPicture',
    'OLE_XSIZE_CONTAINER', 'OLE_YSIZE_CONTAINER', 'FontEvents',
    'OLE_YPOS_CONTAINER', 'Unchecked', 'OLE_YSIZE_PIXELS', 'Picture',
    'FONTSIZE', 'IFontDisp'
]

_check_version('1.1.14', 1622370409.015610)

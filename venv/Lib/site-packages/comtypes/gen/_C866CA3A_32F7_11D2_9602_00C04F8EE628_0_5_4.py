...
__all__ = [
    'SpeechDictationTopicSpelling', 'ISpeechLexiconPronunciation',
    'SWPKnownWordPronounceable', 'SPEI_RESERVED2', 'SVP_8',
    'SP_VISEME_5', 'SRTEmulated', 'DISPID_SABIMinNotification',
    'DISPID_SVEAudioLevel', 'DISPID_SRStatus', 'SLOStatic',
    'DISPID_SVSInputWordPosition', 'SAFT32kHz16BitStereo',
    'DISPID_SRProfile', 'DISPID_SVVoice', 'ISpeechXMLRecoResult',
    'DISPID_SPPValue', 'SITooQuiet', 'ISpeechObjectTokenCategory',
    'SAFT32kHz8BitStereo', 'ISpeechRecoResultTimes', 'SBOPause',
    'ISpStreamFormatConverter', 'DISPID_SPERetainedSizeBytes',
    'SpeechPropertyLowConfidenceThreshold', 'SVEBookmark',
    'SPEI_RESERVED5', 'SPEI_VOICE_CHANGE', 'SREPhraseStart',
    'SRERecognition', 'SAFT8kHz16BitMono', 'DISPID_SRRTStreamTime',
    'SpeechAudioVolume', 'DISPID_SGRSAddRuleTransition', 'UINT_PTR',
    'SREStreamEnd', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTCategory', 'ISpEventSource',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE1', 'SpeechWordPronounceable',
    'DISPID_SPEAudioTimeOffset', 'ISequentialStream',
    'eLEXTYPE_PRIVATE16', 'SSFMOpenForRead',
    'SSSPTRelativeToCurrentPosition', 'SpLexicon',
    'SPEI_WORD_BOUNDARY', 'ISpSerializeState', 'ISpeechVoiceStatus',
    'SpeechCategoryRecoProfiles', 'ISpeechPhraseProperties',
    'DISPID_SLWsCount', 'SpeechGrammarTagUnlimitedDictation',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCEAudioLevel',
    'SSFMOpenReadWrite', 'SPSHORTCUTTYPE', 'DISPID_SPEAudioSizeBytes',
    'SPDKL_LocalMachine', 'DISPID_SDKEnumKeys', 'SAFT44kHz16BitMono',
    'SPLOADOPTIONS', 'DISPID_SDKGetStringValue',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SBSRead', '_SPAUDIOSTATE',
    'SPGRAMMARSTATE', 'DISPID_SVEStreamEnd', 'ISpeechPhraseAlternate',
    'SPAS_PAUSE', 'SWTAdded', 'ISpeechRecoResult2', 'SREStreamStart',
    'SP_VISEME_14', 'SPRST_ACTIVE', 'DISPID_SPIAudioSizeTime',
    'SpeechCategoryAudioIn', 'SGRSTTDictation', 'SREBookmark',
    'SPEI_INTERFERENCE', 'ISpeechMMSysAudio', 'DISPID_SpeechVoice',
    'ISpeechPhoneConverter', 'eLEXTYPE_PRIVATE13',
    'SREFalseRecognition', 'SRERequestUI', 'DISPID_SGRsCount',
    'SP_VISEME_21', 'DISPID_SPRFirstElement', 'SAFT22kHz8BitMono',
    'SpeechEmulationCompareFlags', 'SREStateChange',
    '_ISpeechVoiceEvents', 'DISPID_SVSPhonemeId',
    'DISPID_SRGCmdLoadFromFile', 'SpeechTokenKeyFiles',
    'SPAO_RETAIN_AUDIO', 'SpeechStreamFileMode', 'STSF_LocalAppData',
    'SSSPTRelativeToEnd', 'DISPID_SpeechAudioStatus', 'SP_VISEME_18',
    'DISPID_SOTCSetId', 'DISPID_SVSLastResult',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SVEBookmark',
    'DISPID_SpeechLexiconWord', 'DISPID_SPRuleChildren',
    'SpeechEngineProperties', 'STCAll', 'DISPID_SBSWrite',
    'DISPID_SGRSAddSpecialTransition', 'ISpDataKey',
    'ISpPhoneticAlphabetConverter', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRSetPropertyNumber', 'SDA_No_Trailing_Space',
    'SECNormalConfidence', 'DISPID_SPAStartElementInResult',
    'DISPID_SLPs_NewEnum', 'DISPID_SLPPartOfSpeech', 'ISpStream',
    'DISPID_SRGRecoContext', 'SPEI_TTS_BOOKMARK', 'DISPID_SRGCommit',
    'SAFTADPCM_11kHzMono', 'SVEEndInputStream',
    'DISPID_SOTGetDescription', 'SVEAudioLevel',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPRNumberOfElements',
    'DISPID_SVAlertBoundary', 'ISpRecognizer3', 'DISPID_SASetState',
    'ISpeechObjectTokens', 'SPWORDTYPE', 'ISpeechWaveFormatEx',
    'DISPID_SVESentenceBoundary', 'SVPAlert', 'SPBO_PAUSE',
    'SpeechPropertyResourceUsage', 'DISPID_SFSClose', 'tagSTATSTG',
    'DISPID_SPPChildren', 'Speech_Default_Weight', 'SSTTTextBuffer',
    'DISPID_SGRSTWeight', 'DISPID_SAEventHandle', 'SPBO_TIME_UNITS',
    'SPGS_ENABLED', 'SVP_0', 'DISPID_SGRsItem', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGDictationUnload', 'SPRECOSTATE',
    'DISPID_SpeechPhraseReplacement', 'SpTextSelectionInformation',
    'SPSHORTCUTPAIR', 'DISPID_SDKEnumValues',
    'DISPID_SDKSetLongValue', 'DISPID_SGRsCommit',
    'DISPID_SVSCurrentStreamNumber', 'SAFT48kHz16BitStereo',
    'DISPID_SPIRule', 'DISPID_SDKOpenKey', 'SpeechPartOfSpeech',
    'ISpProperties', 'SPLO_DYNAMIC', 'SSTTDictation', 'SRTSMLTimeout',
    'SpSharedRecognizer', 'DISPID_SRCERequestUI', 'SGSExclusive',
    'DISPIDSPTSI_SelectionOffset', 'SPDKL_DefaultLocation',
    'ISpeechPhraseRule', 'DISPID_SVGetVoices', 'SPGRAMMARWORDTYPE',
    'DISPID_SOTDisplayUI', 'DISPID_SABIBufferSize', 'DISPID_SVSkip',
    'DISPID_SpeechGrammarRuleStateTransition', 'SDTAll', 'SGLexical',
    'SPSNotOverriden', 'DISPID_SpeechGrammarRuleState', 'SLTUser',
    'DISPID_SMSSetData', 'DISPID_SPEAudioStreamOffset',
    'eLEXTYPE_PRIVATE14', 'ISpeechDataKey', 'SPSERIALIZEDRESULT',
    'ISpRecoCategory', 'SPSHORTCUTPAIRLIST', 'SPPHRASEPROPERTY',
    'eLEXTYPE_PRIVATE9', 'SpeechMicTraining', 'SpeechVoicePriority',
    'eLEXTYPE_RESERVED9', 'SAFT32kHz16BitMono',
    'DISPID_SRRAudioFormat', 'DISPID_SPRulesCount',
    'DISPID_SpeechPhoneConverter', 'ISpRecognizer',
    'eLEXTYPE_VENDORLEXICON', 'SPPS_Verb', 'SAFT11kHz16BitStereo',
    'DISPID_SRGId', 'DISPID_SRCEStartStream', 'SAFT44kHz8BitStereo',
    'DISPID_SBSFormat', 'ISpRecoGrammar2',
    'DISPID_SRGetPropertyString', 'SPEI_PHONEME',
    'SAFT24kHz16BitMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE7', 'DISPID_SGRsFindRule',
    'SAFT24kHz8BitMono', 'SAFT12kHz16BitMono', 'SAFT32kHz8BitMono',
    'DISPID_SLAddPronunciation', 'DISPID_SRCResume',
    'eLEXTYPE_PRIVATE17', 'ISpMMSysAudio', 'DISPID_SPRuleConfidence',
    'SPEI_RESERVED1', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SDKGetlongValue', 'SAFT22kHz8BitStereo',
    'DISPID_SPEActualConfidence', 'STSF_FlagCreate',
    'SpeechAllElements', 'SAFTADPCM_8kHzStereo', 'SP_VISEME_2',
    'DISPID_SRSetPropertyString', 'SASPause', 'SPGS_EXCLUSIVE',
    'DISPID_SRCEEndStream', 'SpeechRunState', 'SPVPRI_NORMAL',
    'SPPROPERTYINFO', 'ISpeechAudioBufferInfo', 'SPWT_DISPLAY',
    'SPVPRI_ALERT', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SDKSetBinaryValue',
    'DISPID_SWFESamplesPerSec', 'SPRS_ACTIVE_USER_DELIMITED',
    'eLEXTYPE_USER', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRCERecognitionForOtherContext',
    'SPPS_SuppressWord', 'SPEI_TTS_PRIVATE', 'SpShortcut',
    'DISPID_SADefaultFormat', 'DISPID_SVEPhoneme', 'SPSHT_OTHER',
    'eLEXTYPE_PRIVATE6', 'SPBOOKMARKOPTIONS',
    'DISPID_SPERequiredConfidence', 'SpeechAudioState',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechRecoResult',
    'SPRST_ACTIVE_ALWAYS', '_ISpeechRecoContextEvents', 'SPVPRI_OVER',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRCEFalseRecognition',
    'SP_VISEME_16', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPRS_INACTIVE',
    'DISPID_SPPs_NewEnum', 'SPEVENTENUM', '__MIDL_IWinTypes_0009',
    'SREAdaptation', 'SGRSTTWord', 'DISPID_SVResume',
    'SpeechCategoryVoices', 'SAFT16kHz16BitMono',
    'SAFT24kHz8BitStereo', 'DISPIDSPTSI_ActiveOffset', 'SPFILEMODE',
    'DISPID_SPPNumberOfElements', 'SPAR_Medium',
    'DISPID_SRRDiscardResultInfo', 'SPSSuppressWord',
    'SAFTCCITT_uLaw_22kHzMono', 'SDTDisplayText', 'SECFEmulateResult',
    'SPAS_STOP', 'SPEI_START_INPUT_STREAM', 'SVP_14',
    'ISpXMLRecoResult', 'ISpNotifySink', 'SPSHT_NotOverriden',
    'SpeechPropertyHighConfidenceThreshold', 'Speech_Max_Pron_Length',
    'Speech_StreamPos_RealTime', 'SPGS_DISABLED', 'eLEXTYPE_PRIVATE8',
    'eLEXTYPE_RESERVED8', 'SAFTNoAssignedFormat', 'SRESoundStart',
    'DISPID_SpeechRecoContext', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SFSOpen', 'DISPID_SVWaitUntilDone', 'SPSTREAMFORMATTYPE',
    'ISpPhoneConverter', 'SPPS_Interjection', 'SAFT16kHz8BitStereo',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechAudio',
    'SPEI_RECO_STATE_CHANGE', 'SPVOICESTATUS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechVisemeFeature',
    'eLEXTYPE_RESERVED6', 'SPRECOGNIZERSTATUS', 'SPAUDIOSTATUS',
    'DISPID_SVEEnginePrivate', 'SPPS_Noncontent',
    'ISpeechGrammarRule', 'IEnumString', 'DISPID_SPEs_NewEnum',
    'LONG_PTR', 'DISPID_SpeechGrammarRules', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechVoiceEvent', 'DISPID_SLGetPronunciations',
    'DISPID_SMSALineId', 'SDTRule', 'DISPID_SRSSupportedLanguages',
    'SRAInterpreter', 'DISPID_SRGReset', 'SAFTGSM610_22kHzMono',
    'SVP_21', 'DISPID_SMSGetData', 'ISpeechPhraseInfo',
    'SPEI_REQUEST_UI', 'ISpRecognizer2',
    'ISpeechLexiconPronunciations', 'IStream',
    'IInternetSecurityManager', 'SGRSTTTextBuffer',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'Speech_StreamPos_Asap', 'SpeechTokenKeyUI', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVEStreamStart',
    'SpeechAudioProperties', 'DISPID_SpeechLexicon', 'SGDSActive',
    'SPEI_MAX_SR', 'SWPUnknownWordUnpronounceable',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechVoiceEvents',
    'SPXMLRESULTOPTIONS', 'SPFM_CREATE',
    'DISPID_SpeechRecoContextEvents', 'SFTSREngine',
    'SpeechTokenValueCLSID', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SDKDeleteValue', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechRecoContext', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SWFEExtraData', 'SpeechGrammarState',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SGRSTransitions', 'SVF_None',
    'DISPID_SPPEngineConfidence', 'DISPID_SRRPhraseInfo',
    'ISpeechLexicon', 'DISPID_SGRId', 'DISPID_SLRemovePronunciation',
    'DISPID_SPACommit', 'SRSActive', 'SDA_One_Trailing_Space',
    'DISPID_SLWLangId', 'SPWORDPRONUNCIATION', 'SPFM_OPEN_READWRITE',
    'SVF_Emphasis', 'SVSFPersistXML', 'SpStream',
    'SAFT11kHz8BitStereo', 'DISPID_SRCERecognizerStateChange',
    'SRSInactive', 'DISPID_SVGetAudioInputs',
    'SpeechPropertyResponseSpeed', 'DISPID_SLWWord',
    'DISPID_SRRRecoContext', 'SVEStartInputStream',
    'ISpeechLexiconWord', 'DISPID_SLPPhoneIds', 'SPWF_SRENGINE',
    'SBONone', 'DISPID_SGRSRule', 'SVP_3', 'DISPID_SPEsItem',
    'SPSEMANTICERRORINFO', 'DISPID_SRSAudioStatus', 'eLEXTYPE_APP',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SASCurrentDevicePosition',
    'SpeechCategoryAudioOut', 'SpeechTokenIdUserLexicon',
    'SpMMAudioOut', 'SDTProperty', 'SITooSlow', 'DISPID_SRRTLength',
    'eLEXTYPE_RESERVED7', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SABIEventBias', 'SPWF_INPUT', 'DISPID_SVRate',
    'SRAImport', 'SPPS_RESERVED1', 'SpPhoneticAlphabetConverter',
    'SpInProcRecoContext', 'SpeechTokenShellFolder', 'SVSFVoiceMask',
    'SPPS_Modifier', 'ISpeechGrammarRules', 'SRTStandard',
    'DISPID_SRRSaveToMemory', 'DISPID_SRGState',
    'eLEXTYPE_RESERVED10', 'SVSFParseSapi', 'SPDATAKEYLOCATION',
    'SINone', 'ISpeechVoice', 'SAFTDefault', 'DISPID_SDKDeleteKey',
    'SECFIgnoreWidth', 'SVP_4', 'DISPID_SRRGetXMLErrorInfo',
    'SVSFParseAutodetect', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechSpecialTransitionType', 'DISPID_SpeechPhraseElement',
    'ISpeechPhraseReplacements', 'SPEVENTSOURCEINFO',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechMMSysAudio', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpShortcut', 'SVEPrivate', 'DISPID_SOTCGetDataKey',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRAExport',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTCDefault',
    'SPWORDLIST', 'SPEI_SOUND_END', 'ISpeechRecoGrammar',
    'SpeechRetainedAudioOptions', 'SRADynamic',
    'DISPID_SAFGetWaveFormatEx', 'SVP_19', 'DISPID_SRDisplayUI',
    'STCInprocHandler', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SMSADeviceId',
    'SP_VISEME_17', 'SVP_5', 'SVP_20', 'SpCompressedLexicon',
    'ISpObjectWithToken', 'SREPropertyNumChange', 'SVP_18',
    'SpeechGrammarTagWildcard', 'SPWAVEFORMATTYPE', 'SPBINARYGRAMMAR',
    'SDTAlternates', 'SPEI_PROPERTY_NUM_CHANGE', 'SPINTERFERENCE',
    'DISPID_SLWType', 'DISPID_SRCEInterference',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPIEngineId', 'SpVoice',
    'SpInprocRecognizer', 'SPPHRASEREPLACEMENT', 'SPAS_CLOSED',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechRecoResult',
    'SpeechAudioFormatGUIDText', 'SGLexicalNoSpecialChars',
    'SITooFast', 'eLEXTYPE_USER_SHORTCUT', 'SAFT48kHz8BitMono',
    'SFTInput', 'SP_VISEME_15', 'DISPID_SPIReplacements',
    'DISPID_SVPriority', 'DISPID_SpeechPhraseBuilder',
    'STSF_CommonAppData', 'SAFT16kHz8BitMono',
    'ISpeechResourceLoader', 'DISPID_SRCSetAdaptationData',
    'ISpGrammarBuilder', 'SVSFIsNotXML', 'SAFT8kHz16BitStereo',
    'SpeechCategoryPhoneConverters', 'DISPID_SpeechMemoryStream',
    'ISpRecoGrammar', 'SP_VISEME_4', 'DISPID_SRGDictationSetState',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCRequestedUIType',
    'DISPID_SDKSetStringValue', 'SpeechFormatType', 'SPCS_DISABLED',
    'SPPHRASEELEMENT', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SAFSetWaveFormatEx', 'SPLO_STATIC', 'DISPID_SPIGrammarId',
    'SVP_12', 'DISPID_SVEViseme', 'DISPID_SLWPronunciations',
    'DISPID_SPRuleFirstElement', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SGRAddResource', 'DISPID_SRCPause',
    'DISPID_SVEVoiceChange', 'DISPID_SDKGetBinaryValue',
    'SAFT11kHz8BitMono', 'SLTApp', 'SpeechBookmarkOptions',
    'DISPID_SMSAMMHandle', 'SAFTGSM610_11kHzMono', 'SGRSTTRule',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechCategoryRecognizers',
    'SWTDeleted', 'SDKLDefaultLocation', 'SPSERIALIZEDPHRASE',
    'SREPrivate', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPPParent',
    'SpeechLoadOption', 'DISPID_SpeechLexiconPronunciation', 'SASRun',
    'SPPS_RESERVED2', 'DISPID_SGRInitialState', 'SRSEIsSpeaking',
    'SGDSInactive', 'DISPID_SAFGuid', 'DISPID_SpeechFileStream',
    'SAFT12kHz8BitStereo', 'SVSFParseMask', 'SVSFUnusedFlags',
    'DISPID_SPRuleId', 'DISPID_SLGetGenerationChange',
    'SpNotifyTranslator', 'SpMMAudioIn', 'SPPS_RESERVED3',
    'SPTEXTSELECTIONINFO', 'SGPronounciation',
    'DISPID_SRIsUISupported', 'SRAORetainAudio', 'SVSFNLPMask',
    'DISPID_SRRAudio', 'SP_VISEME_13', 'SpWaveFormatEx', 'SVP_16',
    'DISPID_SRCRetainedAudioFormat', 'SREInterference',
    'ISpeechGrammarRuleStateTransition', 'SAFTADPCM_44kHzMono',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechPhraseRules',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCESoundEnd', 'SRAONone',
    'SDA_Two_Trailing_Spaces', 'SPFM_NUM_MODES',
    'DISPID_SRCEEnginePrivate', 'SpeechRegistryUserRoot',
    'SpeechUserTraining', 'SpeechGrammarWordType', 'SP_VISEME_10',
    'SPCT_SUB_DICTATION', 'ISpStreamFormat', 'DISPID_SPRs_NewEnum',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPEDisplayAttributes',
    'SPCT_COMMAND', 'SPAR_Unknown', 'DISPID_SPEsCount',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpResourceManager',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpNotifySource', 'SPEI_RESERVED3',
    'DISPID_SGRSTType', 'DISPID_SRAudioInputStream',
    'ISpPhoneticAlphabetSelection',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechGrammarTagDictation', 'SPVISEMES', 'DISPID_SPPsCount',
    'SPWT_LEXICAL', 'SPAR_Low', 'SREHypothesis', 'DISPID_SBSSeek',
    'DISPID_SRCEPhraseStart', 'SPEI_HYPOTHESIS', 'SRCS_Disabled',
    'DISPID_SWFEFormatTag', 'SAFT16kHz16BitStereo',
    'DISPID_SRRAlternates', 'ISpPhrase', 'DISPID_SPPName',
    'DISPID_SRGCmdSetRuleState', 'SAFTCCITT_ALaw_44kHzMono',
    'SpPhraseInfoBuilder', 'SAFT24kHz16BitStereo',
    'SPDKL_CurrentUser', 'DISPID_SASNonBlockingIO', 'SAFTText',
    'DISPID_SVSRunningState', 'SGDisplay', 'SVPOver',
    'SpeechDiscardType', 'ISpeechPhraseReplacement',
    'SpUnCompressedLexicon', 'DISPID_SGRs_NewEnum', 'SPEI_SR_PRIVATE',
    'SVSFParseSsml', 'SAFTADPCM_44kHzStereo', 'DISPID_SLPsCount',
    'SPRST_INACTIVE', 'SRSEDone', 'IInternetSecurityMgrSite',
    'DISPID_SPERetainedStreamOffset', 'SPPS_NotOverriden',
    'SAFT22kHz16BitMono', 'DISPID_SGRsAdd', 'ISpeechPhraseElements',
    'DISPID_SRRTimes', 'tagSPPROPERTYINFO', 'SPRS_ACTIVE',
    'SpeechTokenContext', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechLexiconProns', 'SpeechWordType',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRAudioInput', 'SINoise',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechRecoResult2',
    'DISPID_SRGRules', 'eLEXTYPE_PRIVATE19', 'DISPID_SRRecognizer',
    'DISPID_SRCERecognition', 'SpeechAddRemoveWord',
    'ISpeechCustomStream', 'SLODynamic',
    'DISPID_SpeechRecoResultTimes', 'SRERecoOtherContext',
    'DISPID_SOTs_NewEnum', 'SECFIgnoreKanaType',
    'SAFT22kHz16BitStereo', 'DISPID_SPEEngineConfidence',
    'ISpeechLexiconWords', 'SPEI_SR_BOOKMARK',
    'DISPID_SRGetPropertyNumber', 'SECLowConfidence',
    'eLEXTYPE_PRIVATE15', 'ISpObjectToken', 'DISPID_SPPFirstElement',
    'SPEI_END_INPUT_STREAM', 'SECFDefault', 'SPEI_SENTENCE_BOUNDARY',
    'SRATopLevel', 'SVSFIsXML', 'DISPID_SDKCreateKey',
    'DISPID_SOTsItem', 'SRCS_Enabled', 'SpMemoryStream',
    'ISpNotifyTranslator', 'SPWORD', 'SpeechInterference',
    'SP_VISEME_3', 'DISPID_SRCCmdMaxAlternates',
    'SpeechCategoryAppLexicons', 'SRTAutopause', 'DISPID_SPIGetText',
    'SPRST_INACTIVE_WITH_PURGE', 'SPBO_NONE', 'DISPID_SPRsItem',
    'DISPID_SGRSTsCount', 'SAFTCCITT_ALaw_8kHzStereo', 'SITooLoud',
    'ISpRecoContext2', 'ISpeechRecognizer', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRRGetXMLResult', 'SPPS_Unknown', 'SVF_Stressed',
    'SAFT12kHz16BitStereo', 'SPINTERFERENCE_NOISE',
    'DISPID_SPILanguageId', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SVPause', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechGrammarRule', 'SPXRO_Alternates_SML', 'SPVPRIORITY',
    'SPSMF_UPS', 'DISPID_SASFreeBufferSpace', 'SPPHRASE',
    'DISPID_SVGetAudioOutputs', 'eWORDTYPE_ADDED',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SOTDataKey',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPCIdToPhone', 'SVEViseme',
    'DISPID_SRGetFormat', 'SPEI_SR_RETAINEDAUDIO',
    'ISpeechFileStream', 'DISPID_SpeechObjectToken', 'SP_VISEME_7',
    'SPSFunction', 'DISPID_SGRSTText', 'SVP_6',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechRegistryLocalMachineRoot',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SpeechPhraseProperties', 'SREAudioLevel',
    'DISPID_SPIAudioStreamPosition', 'SpeechLexiconType',
    'SPAUDIOOPTIONS', 'DISPID_SpeechCustomStream',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTsItem', 'SVP_11',
    'SpeechVoiceSpeakFlags', 'ISpeechAudio', 'DISPID_SOTsCount',
    'SVP_1', 'ISpeechBaseStream', 'SPEI_MIN_TTS',
    'SGDSActiveUserDelimited', 'DISPIDSPTSI', 'SAFT44kHz8BitMono',
    'DISPID_SGRSTPropertyId', 'DISPID_SVAudioOutputStream',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechWaveFormatEx',
    'SpeechGrammarRuleStateTransitionType', 'SpCustomStream',
    'SDTAudio', 'SVSFlagsAsync', 'SPSLMA', 'SRSActiveAlways',
    'SPAUDIOSTATE', 'SP_VISEME_8', 'DISPID_SVSLastBookmarkId',
    'STSF_AppData', 'DISPID_SLGetWords', 'SPFM_OPEN_READONLY',
    'SPLEXICONTYPE', 'SPEI_FALSE_RECOGNITION',
    'ISpeechRecognizerStatus', 'SPSInterjection',
    'SAFT44kHz16BitStereo', 'SREPropertyStringChange',
    'DISPID_SpeechBaseStream', 'SpeechAudioFormatGUIDWave',
    'SPEI_SOUND_START', 'SpStreamFormatConverter',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPRuleNumberOfElements', 'SPAUDIOBUFFERINFO',
    'SpNullPhoneConverter', 'SVP_10', 'SpeechRecoEvents',
    'DISPID_SPCLangId', 'DISPID_SPISaveToMemory',
    'DISPID_SRGSetTextSelection', 'SGRSTTEpsilon',
    'DISPID_SpeechAudioFormat', 'eLEXTYPE_PRIVATE3',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRGetRecognizers',
    'SVEVoiceChange', 'DISPID_SCSBaseStream', 'DISPID_SLPSymbolic',
    'DISPID_SPELexicalForm', 'DISPID_SGRsCommitAndSave',
    'SpObjectTokenCategory', 'SP_VISEME_11', 'ISpeechPhraseElement',
    'SPRULE', 'DISPID_SVSInputWordLength',
    'SWPUnknownWordPronounceable', 'DISPID_SPIProperties',
    'DISPID_SRCState', 'DISPID_SPRuleName', 'SP_VISEME_1',
    'SPEI_MAX_TTS', 'DISPIDSPTSI_SelectionLength', 'STCInprocServer',
    'SPSVerb', 'ISpObjectTokenCategory', 'SPPHRASERULE',
    'SpeechRecoProfileProperties', 'IEnumSpObjectTokens',
    'SVEWordBoundary', 'SRSInactiveWithPurge',
    'ISpeechPhraseProperty', 'SAFTCCITT_ALaw_8kHzMono',
    'SAFT8kHz8BitMono', 'DISPID_SpeechRecognizerStatus',
    'SDKLLocalMachine', 'DISPID_SAVolume', 'DISPID_SVVolume',
    'SpObjectToken', 'SpeechRuleState', 'SAFTGSM610_44kHzMono',
    'DISPID_SPPsItem', 'DISPID_SLPLangId', 'SRTExtendableParse',
    'SpeechRecoContextState', 'DISPID_SREmulateRecognition',
    'DISPID_SVDisplayUI', 'SPRULESTATE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCEPropertyNumberChange', 'SGRSTTWildcard',
    'SPEI_END_SR_STREAM', 'DISPID_SWFEBitsPerSample',
    'SAFTADPCM_11kHzStereo', 'SPRST_NUM_STATES',
    'DISPID_SGRAttributes', 'ISpEventSink', 'SVEAllEvents',
    'SPAR_High', 'DISPID_SRGIsPronounceable', 'SAFTADPCM_22kHzStereo',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechDataKey',
    'SPRECOCONTEXTSTATUS', 'SAFT8kHz8BitStereo', 'eLEXTYPE_PRIVATE11',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechPhraseAlternates',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_MIN_SR', 'SVSFNLPSpeakPunc',
    'ISpeechRecoResultDispatch', 'SPSModifier',
    'SGDSActiveWithAutoPause', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCVoice', 'DISPID_SRCEAdaptation', '_RemotableHandle',
    'eLEXTYPE_PRIVATE18', 'SPCT_DICTATION',
    'ISpeechTextSelectionInformation', 'DISPID_SGRSTRule',
    'SDA_Consume_Leading_Spaces', 'SPCATEGORYTYPE',
    'eLEXTYPE_PRIVATE5', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPPId', 'DISPID_SRRSpeakAudio', 'SDTReplacement',
    'SPEI_ADAPTATION', 'SPSHT_EMAIL',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPPConfidence',
    'SPAS_RUN', 'SP_VISEME_6', 'SpeechTokenKeyAttributes',
    'WAVEFORMATEX', 'SPCS_ENABLED', 'DISPID_SRRSetTextFeedback',
    'DISPID_SLPsItem', 'SECFIgnoreCase', 'DISPID_SRCCreateGrammar',
    'SPEI_VISEME', 'ISpRecoContext', 'SGSEnabled', 'SVP_7',
    'DISPID_SPRuleParent', 'SRESoundEnd', 'SpSharedRecoContext',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechPropertyAdaptationOn', 'DISPID_SRCEBookmark',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPPS_LMA', 'SPEI_RECOGNITION',
    'SVP_15', 'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseProperty',
    'SAFT48kHz8BitStereo', 'Speech_Max_Word_Length', 'DISPID_SPRText',
    'SpPhoneConverter', 'DISPID_SRGCmdLoadFromResource', 'SVP_17',
    'DISPID_SpeechPhraseElements', 'DISPID_SWFEBlockAlign', 'SVP_13',
    'SECHighConfidence', 'DISPID_SLPType', 'SAFTCCITT_uLaw_8kHzMono',
    'SASStop', 'DISPID_SPIStartTime', 'SPEI_RESERVED6',
    'DISPID_SRCEPropertyStringChange', 'ISpeechAudioStatus',
    'ISpPhraseAlt', 'DISPID_SVGetProfiles', 'DISPID_SRCESoundStart',
    'SPSUnknown', 'SPWT_PRONUNCIATION', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechPhraseRule', 'SPPARTOFSPEECH', 'SP_VISEME_12',
    'DISPID_SOTRemove', 'ISpResourceManager', 'DISPID_SVEWord',
    'SSFMCreate', 'DISPID_SPEDisplayText', 'SPCT_SLEEP',
    'SpMMAudioEnum', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPRsCount',
    'eWORDTYPE_DELETED', 'ISpeechMemoryStream', 'SDTLexicalForm',
    'DISPID_SPCPhoneToId', 'SVP_9', 'DISPID_SPIGetDisplayAttributes',
    'SVEPhoneme', 'SVP_2', 'DISPID_SRSClsidEngine',
    'DISPID_SPRulesItem', 'SPSHT_Unknown', 'SAFTADPCM_22kHzMono',
    'DISPID_SABufferNotifySize', 'DISPID_SGRSTNextState',
    'DISPID_SAStatus', 'SP_VISEME_20', 'SPEI_UNDEFINED',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRsDynamic',
    'SSSPTRelativeToStart', 'SPEI_SR_AUDIO_LEVEL', 'ISpVoice',
    'DISPIDSPRG', 'SpeechRuleAttributes', 'SAFTADPCM_8kHzMono',
    'SREAllEvents', 'DISPID_SOTSetId', 'DISPID_SRCEHypothesis',
    'SPCT_SUB_COMMAND', 'SP_VISEME_9', 'SPAO_NONE',
    'SPEI_PHRASE_START', 'SDTPronunciation', 'SGSDisabled',
    'SPSEMANTICFORMAT', 'DISPID_SOTCId', 'SPPS_Noun',
    'SVESentenceBoundary', 'DISPID_SVSpeakCompleteEvent', 'ISpAudio',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCBookmark',
    'DISPID_SGRName', 'DISPID_SOTIsUISupported',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SVSLastStreamNumberQueued', 'SP_VISEME_0',
    'DISPID_SPIElements', 'DISPID_SLGenerationId', 'SVSFIsFilename',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTNonStandardFormat', 'DISPID_SGRSAddWordTransition',
    'DISPID_SOTCreateInstance', 'DISPID_SVSVisemeId',
    'DISPID_SVIsUISupported', 'DISPID_SWFEChannels',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRIsShared', 'SPSNoun',
    'DISPID_SGRSTPropertyName', 'ISpeechObjectToken',
    'SPINTERFERENCE_NONE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SpFileStream',
    'DISPID_SLWsItem', 'STCRemoteServer', 'ISpLexicon',
    'DISPID_SRGCmdLoadFromObject', 'SAFT11kHz16BitMono',
    'SpeechRecognizerState', 'SPBO_AHEAD',
    'DISPID_SGRSTPropertyValue', 'ISpeechGrammarRuleState',
    'DISPID_SVAudioOutput', 'SPWORDPRONOUNCEABLE',
    'ISpeechPhraseRules', 'SAFT12kHz8BitMono', 'SPEI_START_SR_STREAM',
    'SpeechVisemeType', 'DISPID_SGRAddState', 'SPEVENT',
    'DISPID_SRCRecognizer', 'DISPID_SpeechObjectTokens',
    'DISPID_SRSCurrentStreamNumber', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPEPronunciation', 'SPINTERFERENCE_TOOFAST',
    'SpeechDataKeyLocation', 'SPRECORESULTTIMES', 'DISPID_SVSpeak',
    'DISPID_SRState', 'SSFMCreateForWrite', 'DISPID_SGRClear',
    'SVPNormal', 'DISPID_SRCEventInterests', 'SDKLCurrentConfig',
    'DISPID_SVStatus', 'SAFTExtendedAudioFormat', 'SPXRO_SML',
    'SPCONTEXTSTATE', 'SECFNoSpecialChars',
    'DISPID_SRCreateRecoContext', 'SpeechDisplayAttributes',
    'SPPS_RESERVED4', 'DISPID_SOTCEnumerateTokens', 'SVSFDefault',
    'SPFM_CREATE_ALWAYS', 'SpeechEngineConfidence',
    'SRADefaultToActive', 'DISPID_SPAsItem', 'DISPID_SOTGetAttribute',
    'SP_VISEME_19', 'SINoSignal', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SASState', 'DISPID_SPEAudioSizeTime',
    'SpeechAudioFormatType', 'DISPID_SOTId', 'DISPID_SLWs_NewEnum',
    'SDKLCurrentUser', 'SPDKL_CurrentConfig',
    'DISPID_SPRules_NewEnum', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPARecoResult', 'DISPID_SpeechRecognizer',
    'SAFT48kHz16BitMono', 'DISPID_SPANumberOfElementsInResult',
    'SPPS_Function', 'DISPID_SRRTTickCount', 'ISpRecoResult',
    'SRTReSent', 'ISpeechAudioFormat', 'DISPID_SAFType',
    'SSTTWildcard', 'DISPID_SRCRetainedAudio',
    'DISPID_SRGDictationLoad', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPWORDPRONUNCIATIONLIST', 'SRARoot',
    'DISPID_SpeechXMLRecoResult', 'SpeechStreamSeekPositionType',
    'DISPID_SVEventInterests', 'DISPID_SABufferInfo',
    'DISPID_SPRuleEngineConfidence', 'SpAudioFormat',
    'DISPID_SpeechPhraseInfo', 'STCLocalServer',
    'SpeechRecognitionType', 'DISPID_SPAPhraseInfo', 'SASClosed'
]

_check_version('1.1.14', 1622370450.625252)
